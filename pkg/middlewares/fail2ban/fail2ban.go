...
func TransformRule(r dynamic.Rules) (RulesTransformed, error) {
...
func ImportIP(list dynamic.List) ([]string, error) {
	var rlist []string
...
// request.
func New(_ context.Context, next http.Handler, config dynamic.Fail2ban, name string) (http.Handler, error) {
