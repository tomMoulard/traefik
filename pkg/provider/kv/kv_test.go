...
func Test_buildConfiguration(t *testing.T) {
	provider := newProviderMock(mapToPairs(map[string]string{
		...
		"traefik/http/middlewares/Middleware21/secureHeaders/contentTypeNosniff":                     "true",
		"traefik/http/middlewares/Middleware21/secureHeaders/permissionsPolicy":                      "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/forceSTSHeader":                         "true",
		"traefik/http/middlewares/Middleware21/secureHeaders/sslProxyHeaders/name1":                  "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/sslProxyHeaders/name0":                  "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/allowedHosts/0":                         "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/allowedHosts/1":                         "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/stsPreload":                             "true",
		"traefik/http/middlewares/Middleware21/secureHeaders/frameDeny":                              "true",
		"traefik/http/middlewares/Middleware21/secureHeaders/isDevelopment":                          "true",
		"traefik/http/middlewares/Middleware21/secureHeaders/stsSeconds":                             "42",
		"traefik/http/middlewares/Middleware21/secureHeaders/stsIncludeSubdomains":                   "true",
		"traefik/http/middlewares/Middleware21/secureHeaders/customFrameOptionsValue":                "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/hostsProxyHeaders/0":                    "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/hostsProxyHeaders/1":                    "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/customBrowserXSSValue":                  "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/referrerPolicy":                         "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/contentSecurityPolicy":                  "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/publicKey":                              "foobar",
		"traefik/http/middlewares/Middleware21/secureHeaders/browserXssFilter":                       "true",
	...
	expected := &dynamic.Configuration{
		HTTP: &dynamic.HTTPConfiguration{
			...
			Middlewares: map[string]*dynamic.Middleware{
				...
				"Middleware21": {
					SecureHeaders: &dynamic.SecureHeaders{
						AllowedHosts: []string{
							"foobar",
							"foobar",
						},
