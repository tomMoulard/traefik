...
func methods(tree *matchersTree, methods ...string) error {
	method := methods[0]

	method = strings.ToLower(method)

	tree.matcher = matcher(methodMatcher(func(req *http.Request) bool {
		return method == strings.ToLower(req.Method)
	}))
