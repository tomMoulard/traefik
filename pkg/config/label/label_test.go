...
func TestDecodeConfiguration(t *testing.T) {
	labels := map[string]string{
		...
		"traefik.http.middlewares.Middleware21.secureHeaders.allowedhosts":                         "foobar, fiibar",
		...
		"traefik.http.middlewares.Middleware21.secureHeaders.hostsproxyheaders":                    "foobar, fiibar",
