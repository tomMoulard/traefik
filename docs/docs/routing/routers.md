...
:::note "Requests /foo are Handled by service-foo -- Using the [File Provider](../../providers/file.md)"

<Tabs groupId="dynamic-configuration-example">
<TabItem value="YAML">
...
:::note "Forwarding all (non-tls) requests on port 3306 to a database service"
...
<Tabs groupId="static-configuration-example">
<TabItem value="YAML">
...
:::note "Listens to Every EntryPoint"
